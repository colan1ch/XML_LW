...
import { FilterFormComponent } from "../../components/filter-form/index.js";
...
export class MainPage {
    ...
    getData(filters = {}) {
        ...
        const url = hasFilters 
            ? `${stockUrls.getStocks()}?${new URLSearchParams(filters).toString()}` 
            : stockUrls.getStocks();
    ...
    clearData() {
        const dataContainer = document.getElementById('main-page');
        if (dataContainer) {
    ...
    render() {
        ...
        const filterForm = new FilterFormComponent(this.parent, (filters) => {
